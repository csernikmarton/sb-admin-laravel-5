                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*mcharts') ? 'class="active"' : '') }}>
                            <a href="{{ url ('mcharts') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Charts</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li {{ (Request::is('*table') ? 'class="active"' : '') }}>
                            <a href="{{ url ('table') }}"><i class="fa fa-table fa-fw"></i> Tables</a>
                        </li>
                        <li {{ (Request::is('*form') ? 'class="active"' : '') }}>
                            <a href="{{ url ('form') }}"><i class="fa fa-edit fa-fw"></i> Forms</a>
                        </li>
                        <li >
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> UI Elements<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('*panel') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('panel') }}">Panels and Collapsibles</a>
                                </li>
